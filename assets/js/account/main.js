...
function initialize() {
    var canvas = document.getElementById("canvas");
        ...
        tree = TREE.create("Luqman Asimolowo", "Group Finanacial Controller"),
...
function populateDummyData(tree) {
    ...
    tree.addChild(TREE.create("Level 1", ""));
    tree.addChild(TREE.create("Level 1", ""));
    tree.addChild(TREE.create("Oluwajenyo Babatunde", "Cost Control Engineer PHCL"));
    tree.getChildAt(0).addChild(TREE.create("Quayum Olaniyonu", "Account Assistant- PHCL."));
    tree.getChildAt(1).addChild(TREE.create("Level 2", ""));
    tree.getChildAt(2).addChild(TREE.create("Level 2", ""));
    tree.getChildAt(3).addChild(TREE.create("Level 2", ""));
    tree.getChildAt(4).addChild(TREE.create("Level 2", ""));
    tree.getDescendent(9).addChild(TREE.create("Adewale Adeyemo", "FC- Golden Tulip Ibadan"));
    tree.getDescendent(10).addChild(TREE.create("Level 3", ""));
    tree.getDescendent(11).addChild(TREE.create("Ibrahim Ganiyu", "FC – Five Continents Hospitality services Ibadan"));
    tree.getDescendent(12).addChild(TREE.create("Yunusa Garuba", "FC - Golden Tulip Lekki"));
    tree.getDescendent(14).addChild(TREE.create("Babatunde Akintola", "FC- Golden Tulip Oniru"));
    // tree.getDescendent(7).addChild(TREE.create("Level 3", ""));
