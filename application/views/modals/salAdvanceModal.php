<!-- Leave Modal -->
<div class="modal fade" id="salAdvanceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel1">Salary Advance</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <form method="post" action="updateSalaryAdvance" id="salAdvForm" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label">Repayment duration</label>
                    <textarea class="form-control" name="duration" id="message-text1" readonly></textarea>                                                
                </div>
                <div class="form-group">
                    <label class="control-label">monthly deduction</label>
                    <textarea class="form-control" name="deduction" id="message-text1" readonly></textarea>                                                
                </div>
            </div>
