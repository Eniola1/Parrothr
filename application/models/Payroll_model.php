...
public function getPinFromID($employeeID){
    ...
    public function getSalaryAdvance(){
      ...
      $this->db->where('salary_advance.advance_status', 'Pending');
      $this->db->join("emp_salary", "emp_salary.emp_id = salary_advance.emp_id", "left");
      $this->db->join("employee", "employee.em_id = salary_advance.emp_id", "left");
    ...
    public function getSalaryAdvanceReport(){
      $this->db->select('salary_advance.*');
      $this->db->select('emp_salary.total');
      $this->db->select('employee.first_name');
      $this->db->select('employee.last_name');
    ...
    public function updateSalaryAdvance($id, $data){
      $this->db->where('id', $id);
      $this->db->update('salary_advance', $data);    
    }

    
    /**Get Approved Salary Advance */
    public function approvedSalaryAdvance(){
        $this->db->select('*');
        $this->db->from('salary_advance');
        $this->db->where('advance_status','Approved');
        $this->db->order_by('id', 'DESC');

        $approved = $this->db->get()->result();
        return $approved;
    }
    
    /**Get Awaiting Salary Advance */
    public function awaitingSalaryAdvance(){
        $this->db->select('*');
        $this->db->from('salary_advance');
        $this->db->where('advance_status','Pending');
        $this->db->order_by('id', 'DESC');
    ...
    public function getSalaryAdvanceById($id){
      $this->db->select('salary_advance.*');
      $this->db->select('employee.first_name');
      $this->db->select('employee.last_name');
      $this->db->from('salary_advance');
      $this->db->where('salary_advance.id', $id);
      $this->db->join('employee', 'employee.em_id = salary_advance.emp_id','left');
      $data = $this->db->get()->row();
      return $data;
    }
    
    public function getSalaryAdvanceByEmployee($id){
      $this->db->select('salary_advance.*');
      $this->db->from('salary_advance');
      $this->db->where('salary_advance.emp_id', $id);
      $this->db->order_by('id', 'DESC');
